...
const { findAllBannerController, deleteBannerController } = require("../../controller/banner.controller.js");
...
//delete-banner
router.delete ("/delete-banner/:id", authorize, authorizeRole("admin", "editor"), deleteBannerController)
